/*****************************************************************************
**  $Id: main.cpp,v 1.5 2004/12/14 01:29:35 andrew Exp $
**
    ...
    // Load DXF file into memory and convert it to whatever:
        ...
        while (c<argc) {
            ...
            // page size for PS
                ...
                } else if (!strcmp(argv[c], "Letter") ||
			   !strcmp(argv[c], "LETTER") ||
			   !strcmp(argv[c], "letter")) {
		    pageSize = QPrinter::Letter;
                } else if (!strcmp(argv[c], "Legal") ||
			   !strcmp(argv[c], "LEGAL") ||
			   !strcmp(argv[c], "legal")) {
        ...
        if (rewrite) {
            RS_Graphic graphic;
            RS_FILEIO->fileImport(graphic, argv[1], RS2::FormatUnknown);

            //RS_Export exp(graphic);
            RS_FILEIO->fileExport(graphic, argv[1]);
        } else {
