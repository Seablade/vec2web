/****************************************************************************
** $Id: rs_system.cpp,v 1.34 2004/12/21 03:44:04 andrew Exp $
**
...
*/
static QMap<QCString,QCString> loc_map;

QCString RS_System::localeToISO(const QCString& locale) {
    if (loc_map.isEmpty()) {
